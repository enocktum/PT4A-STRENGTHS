    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto  active o" href="monthlyreport.php">Monthly Report</a></li>
        </ul>
            ...
            <div>
                <p>
                    ...
                    if(isset($diseaseCode) && isset($diseaseCode) && isset($diseaseName))
                    {
						...
						if($diseaseName == "Hypertensive and Diabetic")
						{
							//start both diabetic and hypertensive
							$query=mysqli_query($conn,"SELECT * FROM flat_cdm_summary where location_id='$location_id' && ((htn_status='7285' && dm_status='7281') || (htn_status='7286' && dm_status='7282')) LIMIT 20");
